...
const MULTILINGUAL_URL = process.env.NEXT_PUBLIC_MULTILINGUAL_URL ?? 'http://localhost:8000';
...
export function useVoiceController() {
  ...
  }, [getLangCode, getCurrentScreen, navigate, pathname, toast, speakConfirmation, speakResponse]);
