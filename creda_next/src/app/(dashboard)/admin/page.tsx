...
import { Shield, Users, Activity, Loader2, BarChart3, RefreshCw, Lock } from 'lucide-react';
...
const Admin: React.FC = () => {
  ...
  // Only allow users with admin role (set via Clerk dashboard → public metadata → role: "admin")
  const isAdmin =
    isLoaded &&
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-muted-foreground max-w-xs">This page is only accessible to administrators. Contact your admin if you believe this is an error.</p>
        </div>
      </div>
    );
  }
