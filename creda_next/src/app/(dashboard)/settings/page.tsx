...
const Settings: React.FC = () => {
  ...
  const handleSaveSettings = async () => {
    setSaving(true);
    try {
      // Only send fields that exist in the backend ProfileUpsertRequest schema.
      // UI-only preferences (theme, notifications, privacy, voiceSettings) are
      // stored client-side only and are NOT persisted to the backend.
      await ApiService.upsertProfile({ language: currentLanguage });
      toast({
